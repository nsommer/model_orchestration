= Model Orchestration - orchestrating actions on related models {<img src="https://travis-ci.org/nsommer/model_orchestration.svg?branch=master" alt="Build Status">}[https://travis-ci.org/nsommer/model_orchestration]
